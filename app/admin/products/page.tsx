...
import { isValidImageUrl, getValidImageUrl, PLACEHOLDER_IMAGE } from '@/lib/imageUtils'
...
export default function ProductsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isValidImageUrl(formData.image)) {
      alert('Lütfen geçerli bir görsel URL\'si girin (https:// ile başlamalı ve .jpg, .png, .webp gibi bir uzantıyla bitmelidir)')
      return
    }
  ...
  const handleResetToSamples = async () => {
    if (!confirm('Tüm ürünler silinip örnek ürünler yüklenecek. Emin misiniz?')) return
